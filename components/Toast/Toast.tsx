...
function renderIcon(type: string) {
  switch (type) {
    case 'success':
      return (
        <svg
          ...
          className="h-5 w-5 fill-current stroke-current text-green-500"
        >
    ...
    case 'loading':
      return (
        <svg
          className="loading h-5 w-5 stroke-current text-indigo-500"
          viewBox="25 25 50 50"
        >
...
export const Toast: React.FC<ToastProps> = (props) => {
  ...
  return (
    ...
    >
      <div
        className="my-0 mx-5 flex items-center rounded-3xl bg-white px-5 py-2 shadow"
        role="presentation"
        onClick={handleClick}
      >
