...
function renderIcon(type: string) {
  switch (type) {
    case 'success':
      return (
        <svg
          ...
          className={clsx('w-5 h-5 fill-current stroke-current text-green-500')}
        >
    ...
    case 'error':
      return (
        <svg
          ...
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
          className={clsx('text-red-500 w-5 h-5 fill-current')}
        >
    ...
    case 'loading':
      return (
        <svg
          className={clsx('loading stroke-current text-indigo-500 w-5 h-5')}
          viewBox="25 25 50 50"
        >
